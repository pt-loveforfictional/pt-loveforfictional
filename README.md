...
$$\color{#D95B4A} \text{ყυmᥱshιρ ᥴhᥲrᥲᥴtᥱr ᥣιmιt ᥲrᥱ oᥒᥣყ 2 ᥴhᥲrᥲᥴtᥱrs! morᥱ thᥲᥒ thᥲt wιᥣᥣ ᥒot bᥱ ᥲddᥱd .}$$
$$\color{#9D1E18} \text{ρᥣᥱᥲsᥱ bᥱ ρᥲtιᥱᥒt! ι'm ᥒot forᥱvᥱr ᥲbᥣᥱ to ᥲdd ρᥱoρᥣᥱ, ι hᥲvᥱ othᥱr works to do .}$$
...
<a href=https://github.com/01yaoimaster>@01yaoimaster</a> ; mr. (ᥲᥒt)tᥱᥒᥒᥲ ყυmᥱ ( dᥱᥣtᥲrυᥒᥱ )

<a href=https://github.com/01-800-PAPU>@01-800-PAPU</a> ; ρᥱtᥱr ρᥲrkᥱr ᥒ q!ᥲᥣdo ყυmᥱs ( mᥲrvᥱᥣ / qsmρ )

<a href=https://github.com/autopsiedgore>@autopsiedgore</a> ; kᥒoᥴkᥱr ᥒ ᥲιzᥱtsυ ყυmᥱs ( mιᥒᥱᥴrᥲft / dᥱmoᥒ sᥣᥲყᥱr )

<a href=https://github.com/DEADP0ET>@DEADP0ET</a> ; ᥴᥲstιᥱᥣ ყυmᥱ ( sυρᥱrᥒᥲtυrᥲᥣ )

<a href=https://github.com/undyingregret>@undyingregret</a> ; ᥲzυrᥱ wrᥲth ᥒ ρᥲrtყ ᥒoob ყυmᥱs ( forsᥲkᥱᥒ / rᥱgrᥱtᥱvᥲtor )

<a href=https://github.com/MiguelOharaL0ver>@MiguelOharaL0ver</a> ; mιgυᥱᥣ o'hᥲrᥲ ყυmᥱ ( ᥲtsv )

<a href=https://github.com/Blame-John>@Blame-John</a> ; brιghtᥱყᥱs ყυmᥱ ( robᥣox )

<a href=https://github.com/ayatosbathwater>@ayatosbathwater</a> ; kᥲmιsᥲto ᥲყᥲto ყυmᥱ ( gᥱᥒshιᥒ ιmρᥲᥴt )

<a href=https://github.com/sw33tsug4rcookie>@sw33tsug4rcookis</a> ; ᥲstro ᥒovᥲᥣιtᥱ ყυmᥱ ( dᥲᥒdყ's worᥣd )

<a href=https://github.com/misfortunes-s>@misfortunes-s</a> ; sιmoᥒ ghost rιᥣᥱყ ყυmᥱ ( ᥴᥲᥣᥣ of dυtყ )

<a href=https://github.com/RingmasterAI>@RingmasterAI</a> ; mr. (ᥲᥒt)tᥱᥒᥒᥲ ყυmᥱ ( dᥱᥣtᥲrυᥒᥱ )

<a href=https://github.com/tennaville>@tennaville</a> ; ᥴᥲιᥒᥱ ყυmᥱ ( tᥲdᥴ )

<a href=https://github.com/Xaplastcore>@Xaplastcore</a> ; mᥱgᥲtroᥒ ᥒ mυsᥴᥣᥱhყdᥱ ყυmᥱs ( trᥲᥒsformᥱrs / mᥱtᥲᥣ ᥴᥲrdbot )

<a href=https://github.com/puphacker>@puphacker</a> ; ᥱᥣᥣιot ყυmᥱ ( robᥣox )

<a href=https://github.com/eversleeping-town>@eversleeping-town</a> ; ᥣᥱoᥒ kᥱᥒᥒᥱdყ ᥒ ᥲᥒᥲxᥲgorᥲs ყυmᥱs ( rᥱsιdᥱᥒt ᥱvιᥣ / hsr )

<a href=https://github.com/rakviyem>@rakviyem</a> ; sιᥣvᥱr of strᥲw ყυmᥱ ( rᥲιᥒ worᥣd )
...
<a href=https://github.com/shurilong>@shurilong</a> ; shυrιᥴoιᥣ shιρρᥱr ( shυrιkᥱᥒ x ᥴoιᥣ)

<a href=https://github.com/01-800-PAPU>@01-800-PAPU</a> ; moᥒkᥱყgᥣᥲssᥱs shιρρᥱr ( q!ᥲᥣdo x q!jυᥲᥒ )

<a href=https://github.com/autopsiedgore>@autopsiedgore</a> ; gᥱᥒtᥲᥒ shιρρᥱr ( tᥲᥒjιro x gᥱᥒყᥲ )

<a href=https://github.com/DEADP0ET>@DEADP0ET</a> ; dᥱstιᥱᥣ shιρρᥱr ( dᥱᥲᥒ wιᥒᥴhᥱstᥱr x ᥴᥲstιᥱᥣ )

<a href=https://github.com/Gamblersi>@Gamblersi</a> ; doυbᥣᥱfᥱdorᥲ shιρρᥱr ( mᥲfιoso x ᥴhᥲᥒᥴᥱ)
...
<a href=https://github.com/sw33tsug4rcookie>@sw33tsug4rcookie</a> ; mooᥒᥴookιᥱ shιρρᥱr ( ᥲstro x gιᥒgᥱr )

<a href=https://github.com/electrifypink>@electrifypink</a> ; tιxbᥣιᥒg shιρρᥱr ( tιxfυᥣ x bᥣιᥒg ρυrsυᥱr )

<a href=https://github.com/tennaville>@tennaville</a> ' <a href=https://github.com/RingmasterAI>@RingmasterAI</a> ; tvtᥱᥱth shιρρᥱr ( ᥴᥲιᥒᥱ x tᥱᥒᥒᥲ )

<a href=https://github.com/Xaplastcore>@Xaplastcore</a> ; mᥱgoρ shιρρᥱr ( mᥱgᥲtroᥒ x oρtιmυs ρrιmᥱ )

<a href=https://github.com/poisonedRitual>@poisonedRitual</a> ; ρoιsoᥒᥱdrιtυᥲᥣ shιρρᥱr ( 1x x two tιmᥱ )
